...
from fiskhr.core.errors import CisError, FiskalizacijaError
...
class FiskalizacijaClient:
    ...
    Args:
        ...
        env: Target environment; selects the endpoint from
            `fiskhr.f1.service.SERVICE_URLS`.
        ...
        transport: Optional httpx transport, injectable for testing —
            `fiskhr.testing.MockCis` plugs in here.
    ...
    caller via `fiskhr.core.xmldsig.verify_enveloped` until certificate
