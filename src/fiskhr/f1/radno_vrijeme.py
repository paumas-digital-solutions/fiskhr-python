...
from fiskhr.f1.messages import DATUM_VRIJEME_FORMAT, F73_NS
from fiskhr.f1.models import Greska, Oib, PorukaOdgovora, _Model
...
def parse_dohvati_radno_vrijeme_odgovor(xml: bytes | etree._Element) -> RadnoVrijemeOdgovor:
    ...
    from fiskhr.f1.messages import _parse_greske, _parse_zaglavlje
