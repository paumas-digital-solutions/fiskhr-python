...
Schematron validation needs an XSLT 2.0 engine and is an optional extra::
    ...
    pip install fiskalhr[validation]
...
from fiskalhr.f2.validation.report import Severity, ValidationFinding, ValidationReport
from fiskalhr.f2.validation.validate import validate
