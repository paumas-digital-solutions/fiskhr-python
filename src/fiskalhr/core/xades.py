...
Unlike F1 (`fiskalhr.core.xmldsig`), the message root's ``id`` attribute is
...
from fiskalhr.core.xmldsig import XmlInput, _as_element, _embedded_certificate
...
def verify_xades_enveloped(
    ...
    *,
    ...
    Mirrors `fiskalhr.core.xmldsig.verify_enveloped`: a caller must either
